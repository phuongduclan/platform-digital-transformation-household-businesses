...
import { OwnerCustomer } from "@/services/owner.service";

type StatusFilter = "" | "INCREASE" | "DECREASE" | "ADJUST";

interface DebtRecordWithCustomer extends EmployeeDebtRecord {
  customer_name?: string;
}

export default function EmployeeDebtRecordsPage() {
  const [customers, setCustomers] = useState<OwnerCustomer[]>([]);
  const [records, setRecords] = useState<EmployeeDebtRecord[]>([]);
  ...
  const [detailRecord, setDetailRecord] =
    useState<DebtRecordWithCustomer | null>(null);
  ...
  const getTypeLabel = (record: EmployeeDebtRecord) => {
