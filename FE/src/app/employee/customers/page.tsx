...
import type { OwnerCustomer } from "@/services/owner.service";
...
export default function EmployeeCustomersPage() {
  ...
  const fetchCustomers = async () => {
    try {
      setLoading(true);
      const data = await employeeService.listCustomers();
      setCustomers(data || []);
    } catch (error: any) {
      const message =
    ...
    <>
      ...
      <div className="p-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          {/* Employee không được tạo khách hàng nên không có nút Tạo */}
        </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <Link
                            href={`/employee/debt-records/${c.id}`}
                          ...
                          {/* Employee không có quyền chỉnh sửa/xóa khách hàng */}
                        </div>
                      </td>
                    </tr>
                  ))
