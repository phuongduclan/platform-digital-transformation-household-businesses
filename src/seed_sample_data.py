...
def seed_sample_data():
    ...
    with app.app_context():
        try:
            ...
            session.flush()
            print(f"[OK] Da tao Owner User: {owner_user.username} (ID: {owner_user.id}, Household ID: {owner_user.household_id})")
            ...
            session.flush()
            print(f"[OK] Da tao Employee User: {employee_user.username} (ID: {employee_user.id}, Household ID: {employee_user.household_id})")
            ...
            print(f"   - Owner: {owner_user.username} / owner123")
            print(f"   - Employee: {employee_user.username} / emp123")
